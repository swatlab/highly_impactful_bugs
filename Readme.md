...
- Run **crash_parser.py** to parse a group of crash reports
    - There are two options to identify unique user, *i.e.,* by *installing profile* (Khomh et al.'s approach <ref>reference</ref>) or by *machine profile* (approach in this paper). The script will alert you to choose one of the options.
